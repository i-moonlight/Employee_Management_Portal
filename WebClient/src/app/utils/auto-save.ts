...
export function autoSave(
  ...
  object: ((text: string, reviver?: (this: any, key: string, value: any) => any) => any) = JSON.parse,
  value: ((value: any, replacer?: (this: any, key: string, value: any) => any, space?: string | number) => string) = JSON.stringify
): PropertyDecorator {
...
function createSetter(
  ...
  value: ((value: any, replacer?: (this: any, key: string, value: any) => any, space?: string | number) => string),
